"""
CookingMadeEasy Auto Post Generator v2
...
BLOG_NAME = "CookingMadeEasy"
BLOG_NICHE = "cooking and recipes"
BLOG_DESCRIPTION = "Simple, delicious recipes and cooking tips for busy home cooks."

CATEGORIES = [
    "easy-recipes",     "meal-prep",     "baking",     "healthy-cooking",
    "kitchen-tips",     "budget-meals",     "international",     "quick-meals",
    "slow-cooker",     "air-fryer",     "vegetarian",     "desserts",
    "breakfast",     "dinner-ideas",     "snacks",
]

SYSTEM_PROMPT = """You are an expert cooking and recipes writer for CookingMadeEasy.
...
- Write as a professional chef and home cooking expert sharing expertise
