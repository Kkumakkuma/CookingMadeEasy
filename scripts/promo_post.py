"""
CookingMadeEasy - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "desc": "Organize all your favorite recipes in one beautiful Notion template.",
        "keywords": ["recipe organization", "meal planning", "cooking collection", "recipe book"],
    },
    {
        "name": "Grocery Budget Tracker",
        "price": "$5.99",
        "slug": "grocery-tracker",
        "desc": "Save money on groceries with our smart budget tracking template.",
        "keywords": ["grocery budgeting", "food savings", "meal budget", "grocery planning"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert cooking and recipes writer.
