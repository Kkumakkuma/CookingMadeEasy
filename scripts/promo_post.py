"""
CookingMadeEasy - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Recipe Organizer", "price": "$6.99", "slug": "recipe-organizer", "desc": "Your personal digital cookbook with meal planning integration."},
    {"name": "Grocery Budget Tracker", "price": "$5.99", "slug": "grocery-budget", "desc": "Stop overspending on groceries with smart tracking."},
]

PROMO_SYSTEM_PROMPT = """You are an expert cooking writer.
